...
alias dkR='docker run -e COLUMNS=`tput cols` -e LINES=`tput lines` -it --rm'
alias dkRe='docker run -e COLUMNS=`tput cols` -e LINES=`tput lines` -it --rm --entrypoint /bin/bash'
...
alias dkCE='docker container exec -e COLUMNS=`tput cols` -e LINES=`tput lines` -it'
...
alias dkCR='docker container run -e COLUMNS=`tput cols` -e LINES=`tput lines` -it --rm'
alias dkCRe='docker container run -e COLUMNS=`tput cols` -e LINES=`tput lines` -it --rm --entrypoint /bin/bash'
